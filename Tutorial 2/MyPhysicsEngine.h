...
//		pairFlags |= PxPairFlag::eCCD_LINEAR;
	...
	public:
		...
		{
			truncheon = new Truncheon(PxTransform(PxVec3(0.f, 2.f, -40.85714287f), PxQuat(PxPi / 4, PxVec3(-1.0f, 0.0f, 0.0f))));
		...
		void Ball() 
		{
			...
			rugbyBall = new RugbyBall(PxTransform(PxVec3(0.f, 1.f, -42.5f)));
			rugbyBall->Material(rubberMat);
			rugbyBall->Color(PxVec3(140.f / 255.f, 83.f / 255.f, 62.f / 255.f));
			rugbyBall->Get()->is<PxRigidDynamic>()->setMass(1);
			Add(rugbyBall);
		}
